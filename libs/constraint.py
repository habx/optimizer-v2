...
ELEMENT_CONSTRAINT_SEED = {
    'max_duct': SpaceConstraint(max_size,
                            {"max_size": Size(40000, 200, 200),
                             "category_name": "seed"},
                            "max_size_xs"),
    'min_duct': SpaceConstraint(min_size,
                                {"min_size": Size(5000, 50, 50),
                                 "category_name": "seed"},
                                "min_size_xs"),
...
CONSTRAINTS = {
    ...
    "max_size_duct_constraint_seed": ELEMENT_CONSTRAINT_SEED['max_duct'],
    "min_size_duct_constraint_seed": ELEMENT_CONSTRAINT_SEED['min_duct'],
