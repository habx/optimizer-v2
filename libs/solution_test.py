...
def test_distance_different_plans():
    """
    Test
    :return:
    """
    ...
    bedroom_coords = [(500, 0), (1000, 0), (1000, 1000), (500, 1000)]
    ...
    plan2 = Plan("2")
    floor_1 = plan2.add_floor_from_boundary(boundaries, floor_level=0)
    living_coords = [(500, 0), (1000, 0), (1000, 1000), (500, 1000)]
    bedroom_coords = [(0, 0), (500, 0), (500, 1000), (0, 1000)]
    plan2.insert_space_from_boundary(living_coords, SPACE_CATEGORIES["living"], floor_1)
    plan2.insert_space_from_boundary(bedroom_coords, SPACE_CATEGORIES["bedroom"], floor_1)
    plan2.plot()

    collector.add_solution(plan1)
    collector.add_solution(plan2)

    assert collector.solutions[0].distance(collector.solutions[1]) == 100, "Wrong distance"

def test_distance_similar_plans():
    """
    Test
    :return:
    """
    ...
    assert collector.solutions[0].distance(collector.solutions[1]) == 0, "Wrong distance"
...
if __name__ == '__main__':
    ...
    test_solution()
    test_distance_different_plans()
    test_distance_similar_plans()